...
<li><a href="http://localhost/Toys/add_product.php">Add Product</a></li></a></li>
</ul>
</div>
<div class="banner">        
...
<div class="right">
	<div class="enter">
	 <form method="POST">
		<table style="color: black; font-size: 40px;">
			<tr>
				<td>User id :</td>
...
$connect = mysqli_connec('3.132.234.157','quang','123@123a','toy');
if(!$connect){
   ...
   if(isset($_POST['Register'])){
    ...
    if($result){
       echo "<script> alert('Register successfully')</script>";
    	...
    	echo "<script> alert('userid or username already exists ')</script>";
